const defaultDraft = {
  letterhead: {
    company_name: "LAKSHMI CARBIDE",
    tagline: "(HOUSE OF GASES)",
    address: "# 19/2, Saphera Road, Ambala - Jagadhri Road, Khudda, Ambala Cantt. - 133 001",
    gstin: "06AAAF L3225A1Z4".replace(/\s+/g, ""),
    mobile: "89013-55555",
    logo_asset_id: null,
  },
  meta: {
    ...
    attention: "",
    subject: "Quotation",
    intro: "We thank you for the opportunity to quote for the above requirement. Please find our detailed offer below for your kind consideration.",
  },
  line_items: [
    { description: "", qty: "", rate: "", amount: "", auto: true },
  ],
  terms: {
    payment_terms: "40% advance, 50% against dispatch, 10% after completion.",
    delivery: "10-12 weeks from confirmation.",
